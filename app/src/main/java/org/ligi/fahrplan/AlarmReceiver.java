...
public final class AlarmReceiver extends BroadcastReceiver {
    ...
    public static final String ALARM_LECTURE = "org.ligi.fahrplan.congress.ALARM_LECTURE";

    public static final String ALARM_UPDATE = "org.ligi.fahrplan.congress.ALARM_UPDATE";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intent.getAction().equals(ALARM_LECTURE)) {
            ...
            db.delete(FahrplanContract.AlarmsTable.NAME, FahrplanContract.AlarmsTable.Columns.EVENT_ID + "=?",
