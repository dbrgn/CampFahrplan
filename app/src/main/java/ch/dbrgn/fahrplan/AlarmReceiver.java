...
public final class AlarmReceiver extends BroadcastReceiver {
    ...
    public static final String ALARM_LECTURE = "ch.dbrgn.fahrplan.zeteco.ALARM_LECTURE";

    public static final String ALARM_UPDATE = "ch.dbrgn.fahrplan.zeteco.ALARM_UPDATE";
